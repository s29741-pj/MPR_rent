...
//
//        assertTrue(rentService.checkIfAvailable(customerStorage, 1, rentalStorage));
//    }
//
//    @Test
...
//        carService.checkIfAvailable(rentService, rentalStorage, customerStorage, 1, carStorage);
//
//        assertFalse(rentService.checkIfAvailable(customerStorage, 1, rentalStorage));
//    }
//
...
//
//        assertFalse(rentService.checkIfAvailable(customerStorage, 1, rentalStorage));
//        assertFalse(rentService.checkIfAvailable(customerStorage, 2, rentalStorage));
//        assertFalse(rentService.checkIfAvailable(customerStorage, 3, rentalStorage));
//        assertFalse(rentService.checkIfAvailable(customerStorage, 4, rentalStorage));
//    }
//
//    @Test
...
//
//        assertTrue(rentService.checkIfAvailable(customerStorage, 1,rentalStorage));
//        assertTrue(rentService.checkIfAvailable(customerStorage, 2,rentalStorage));
//        assertTrue(rentService.checkIfAvailable(customerStorage, 3,rentalStorage));
//    }
//
//
//}
